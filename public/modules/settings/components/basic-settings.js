        ...
        <div class="col-lg-3">
          <div class="form-group">
            ...
            <input name="organization"
                  ...
                  data-ng-model="$ctrl.formModel.organization"
                  required>
          </div>
        </div>
        ...
        <div class="col-lg-2">
          <div class="form-group">
            ...
            <input name="url"
                  ...
                  data-ng-model="$ctrl.formModel.url"
                  required>
          </div>
        </div>
        <div class="clearfix visible-sm-block visible-md-block"></div>
        ...
        <div class="col-lg-2">
          <div class="form-group">
            ...
            <input name="clientIntakeNumber"
                  ...
                  data-ng-model="$ctrl.formModel.clientIntakeNumber"
                  required>
          </div>
        </div>
        <div class="clearfix visible-sm-block visible-md-block"></div>
        <div class="col-lg-3">
          <div class="form-group">
            ...
            <input name="supportNumber"
                  ...
                  data-ng-model="$ctrl.formModel.supportNumber"
                  required>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <textarea name="mission"
                      ...
                      class="form-control"
                      rows="5"
                      data-ng-model="$ctrl.formModel.mission"
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <textarea name="instructions"
                      ...
                      class="form-control"
                      rows="5"
                      data-ng-model="$ctrl.formModel.instructions"
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <textarea name="thanks"
                      ...
                      class="form-control"
                      rows="5"
                      data-ng-model="$ctrl.formModel.thanks"
